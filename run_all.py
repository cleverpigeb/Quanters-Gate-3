...
from src.data_fetcher import fetch_universe_daily_bars
...
from src.stock_pool import normalize_symbols
...
def main() -> None:
    ...
    raw_data = fetch_universe_daily_bars(symbols, args.start, args.end)
